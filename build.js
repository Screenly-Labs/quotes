...
//   4. bundle TypeScript → browser JS (minified, ./quotes inlined)
...
// 4. TypeScript → browser JS with esbuild. Bundles main.ts (inlining ./quotes
...
const fingerprint = await Promise.all([
  ...
  readFile(`${DIST}/static/data/quotes.json`)
])
